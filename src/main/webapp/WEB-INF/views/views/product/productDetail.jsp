...
function qnaShowFunction(){
	...
	.done(function(resp){
		...
		$.each(resp, function(key, val){	
			...
			htmlStr += "<td><a onclick='javascript:qnaViewFunction("+val.qnum+")' id='qnatitle'>"+val.title+"</a></td>";
...
function revShowFunction(){
	...
	.done(function(resp){
		...
		$.each(resp, function(key, val){	
			...
			htmlStr += "<td>"+afterStr[0]+"</td>";
		//	htmlStr += "<td><a onclick='javascript:revViewFunction("+val.rnum+")' id='revtitle'>"+val.title+"</a></td>";
			htmlStr += "<td>"+val.create_date+"</td>";
			htmlStr += "<td>"+val.rate+"</td>";
			htmlStr += "</tr>";
		});
...
//리뷰 상세보기
function revViewFunction(rnum){
	location.href="/review/detail/"+rnum;
}
